...
const SignupCard = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        let res = await fetch(`${GLOBAL_CONSTANTS.base_url}/api/signup`, {
            method: 'POST',
            headers: {
            ...
            <form className={styles.form} onSubmit={handleSubmit} method="post">
                ...
                <div className={styles.inputfieldcontainer}>
                    ...
                    <div className={styles.password__group}>
                        ...
                        <label for="password" className={styles.password__label}>Your Password</label>
                    ...
                    <div className={styles.optionscontainer}>
                        <div className={styles.checkboxcontainer}>
                            <input onChange={handleChange} type="checkbox" name="checkbox" id="checkbox" />
